...
export const TestDialog = ({ open, onClose, pos, group }: TestDialogProps) => {
  ...
  const {
    ...
    isFlashing,
    cancelFlash,
  } = useJudgementHandler(choiceView, goNextOrClose, questionKey);
  ...
  const showTranslationComputed = shouldShowTranslation(display.showTranslation, isFlashing, !!item?.jp);
